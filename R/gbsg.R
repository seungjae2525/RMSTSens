...
#'
#' @description The \code{gbsg} data set contains patient records from a 1984\enc{–}{--}1989 trial conducted by the German Breast Cancer Study Group (GBSG) of 720 patients
...
#'
#' @references Royston, P., and Altman, D. G.
#' External validation of a Cox prognostic model: principles and methods.
#' \emph{BMC Medical Research Methodology}. 2013.
