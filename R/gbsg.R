...
#'
#' @description The \code{gbsg} data set contains patient records from a 1984-1989 trial conducted by the German Breast Cancer Study Group (GBSG) of 720 patients
#' with node positive breast cancer; it retains the 686 patients with complete data for the prognostic variables.
#'
#' @usage gbsg
#'
...
#'}
#'
#' @details These data sets are used in the paper by Royston and Altman (2013). The Rotterdam data is used to create a fitted model,
#' and the GBSG data for validation of the model. The paper gives references for the data source.
#'
#' @references Patrick Royston and Douglas Altman, External validation of a Cox prognostic model: principles and methods.
#' \emph{BMC Medical Research Methodology} 2013, 13:33
#'
